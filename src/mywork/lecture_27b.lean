...
begin
  ...
  unfold single_valued,
  apply and.intro,
  assume x y z inrxy inrxz,
  unfold inverse at inrxy inrxz,
  apply r_one_to_one inrxy inrxz,
  ...
  apply and.intro,
  apply and.intro,
  assume x y z irxy ixz,
  unfold inverse at irxy ixz,
  apply r_one_to_one irxy ixz,
